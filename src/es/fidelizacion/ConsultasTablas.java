...
public class ConsultasTablas extends JFrame {
    ...
    public ConsultasTablas(){
    	...
    	String[] columnas = {"Codigo Barras","ID Cliente","Fecha Alta","Nombre","1º Apellido","2º Apellido",
     ...
     // Parametros de la ventana
        ...
        Basedatos.ConsultarTablasClientes();
